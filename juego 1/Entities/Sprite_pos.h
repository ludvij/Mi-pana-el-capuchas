...
#define PLAYER_IDLE_BACK_POS 0,1
#define PLAYER_IDLE_FRONT_POS 0,4
#define PLAYER_IDLE_LEFT_POS 0,7
#define PLAYER_IDLE_RIGHT_POS 0,10
// player moving animations
#define PLAYER_MOVING_DOWN_POS 1,0
#define PLAYER_MOVING_UP_POS 1,4
#define PLAYER_MOVING_LEFT_POS 1,8
#define PLAYER_MOVING_RIGHT_POS 1,12
//enemies
// cyan enemy
#define CYAN_ENEMY_POS 0,2
//cyan enemy animation
#define CYAN_ENEMY_IDLE_POS 1,2
#define CYAN_ENEMY_DEATH_POS 4,2
// veteran enemy 
#define VETERAN_ENEMY_POS 0,3
// veteran enemy animatioons
#define VETERAN_ENEMY_IDLE_POS 1,3
#define VETERAN_ENEMY_DEATH_POS 4,3
// red enemy 
#define RED_ENEMY_POS 0,4
// red enemy animatioons
